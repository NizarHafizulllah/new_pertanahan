...
function printper(id){
  ...
  window.open('<?php echo site_url("$this->controller/pdfper?id=") ?>'+id);
...
function printket(id){
  ...
  window.open('<?php echo site_url("$this->controller/pdfket?id=") ?>'+id);
...
function printber(id){
  ...
  window.open('<?php echo site_url("$this->controller/pdfberita?id=") ?>'+id);
