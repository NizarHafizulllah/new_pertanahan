...
function get_data_penduduk(){
  ...
  function pdfper() {
    ...
    // $data['title'] = $data['header'];
        ...
        $utama = $this->dm->get_tanah_utama($id)->row();
        $pemilik = $this->dm->get_pemilik_detail($utama->id_tanah)->result();
        $saksi = $this->dm->get_saksi_detail($id)->result();
        ...
        $html = $this->load->view("pdf/surat_pernyataan",$data,true);
         ...
         $pdf->Output("Surat Pernyataan". $this->session->userdata("tahun") .'.pdf', 'FI');
}
