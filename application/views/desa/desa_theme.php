...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/bootstrap/bootstrap-dialog.min.css">
	...
	<body class="hold-transition skin-blue sidebar-mini">
	  ...
	  <div class="wrapper"> 
        ...
        <!-- Logo -->
		  <a href="<?php echo site_url('desa'); ?>" class="logo">
          <!-- mini logo for sidebar mini 50x50 pixels -->
			<span class="logo-mini"><b>D</b>s</span>
			<!-- logo for regular state and mobile devices -->
			<span class="logo-lg"><b>Desa </b></span>
		  </a>
					  ...
					  <li class="user-header">
							<p><?php echo $userdata['nama'] ?>
						  	<small><?php echo $userdata['username'] ?></small>
								...
								<p><h2 style="color: white;">Desa</h2></p>
						</li>	
                  <!-- Menu Footer-->
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo site_url('profil_desa'); ?>" class="btn btn-default btn-flat">Pengaturan</a>
                    </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo site_url('pelepasan_tanah_desa'); ?>"><i class="fa fa-folder"></i> Pelepasan Tanah</a></li>
              </ul>
            </li>
          </ul>
        </section>
